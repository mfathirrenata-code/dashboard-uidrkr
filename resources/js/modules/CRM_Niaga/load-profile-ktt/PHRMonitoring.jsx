...
const COLOR    = '#2E7DD4';
const LABEL    = 'PHR';
const SUBTITLE = 'PT Pertamina Hulu Rokan';

export const PHRMonitoring = ({ data = [] }) => {
  const t = getTokens();

  if (!data.length) {
    return (
      <div className="space-y-6">
        <PageHeader icon={Building2} title={LABEL} subtitle={SUBTITLE} color={COLOR} />
        <div className="rounded-2xl p-5" style={{ background: t.cardBg, border: `1px solid ${t.cardBorder}` }}>
          <div className="text-center py-16">
            <Building2 className="w-12 h-12 mx-auto mb-4" style={{ color: t.textSub }} />
            <p className="text-base font-semibold" style={{ color: t.textPrimary }}>Data PHR Belum Tersedia</p>
