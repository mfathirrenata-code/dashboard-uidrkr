...
export default function DashboardUIDRKR() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setError(null);
      try {
        // Sesuaikan URL API jika berbeda di lingkungan produksi
  ...
  return (
    <main className="flex-1 overflow-x-hidden overflow-y-auto bg-[#F8FAFC] p-4 md:p-6 lg:p-8">
      ...
      <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h2 className="text-2xl md:text-3xl font-black text-[#0F172A] tracking-tight">Dashboard Realisasi</h2>
          <p className="text-sm text-[#64748B] font-medium mt-1">Performa PLN Mobile UID Riau & Kepri</p>
        </div>
